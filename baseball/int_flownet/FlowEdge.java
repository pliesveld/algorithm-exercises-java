...
public class FlowEdge {
    ...
    public FlowEdge(int v, int w, int capacity) {
        ...
        if (!(capacity >= 0)) throw new IllegalArgumentException("Edge capacity must be nonnegaitve");
        this.v         = v;
        this.w         = w;  
    ...
    public FlowEdge(int v, int w, int capacity, int flow) {
        ...
        if (!(flow >= 0))        throw new IllegalArgumentException("Flow must be nonnnegative");
        this.v         = v;
        this.w         = w;  
        this.capacity  = capacity;
        this.flow      = flow;
    ...
    public String toString() {
        return v + "->" + w + " " + flow + "/" + (capacity == Integer.MAX_VALUE ? "\u221E" : capacity);
    }
   ...
   /**
    ...
    public static void main(String[] args) {
        FlowEdge e = new FlowEdge(12, 23, 12);
        StdOut.println(e);
    }
